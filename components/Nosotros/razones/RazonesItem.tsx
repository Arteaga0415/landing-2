type RazonesData = {
  activeRazones: number;
  id: number;
  handleRazonesToggle: (id: number) => void;
  quest: string;
  ans: string;
};

const RazonesItem = ({ razonesData }: { razonesData: RazonesData }) => {
  const { activeRazones, id, handleRazonesToggle, quest, ans } = razonesData;
